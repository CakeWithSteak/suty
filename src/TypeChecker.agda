...
... | no t-untypable = no λ {(_ , TAbs {T₂ = T₂} {Γ₂ = Γ₂} _ _ _ t-typable _) → contradiction ((T₂ , Γ₂) , t-typable) t-untypable}
... | yes ((T₂ , Γ₂) , T₂-proof) with divideContext Γ₂ (∅ , x ↦ T₁)
... | no Γ₂-nodiv = no λ {(_ , TAbs {Γ₃ = Γ₃} _ _ _ t-typable Γ₂-div) → case typing-unique T₂-proof t-typable of λ { (refl , refl) → contradiction (Γ₃ , Γ₂-div) Γ₂-nodiv }}
... | yes (Γ₃ , Γ₃-proof) = yes (((` q ` T₁ ⇒ T₂) , Γ₃) , (TAbs x-uniq q-not-ord Γ-containment T₂-proof Γ₃-proof))
...
... | no t₁-untypable = no λ {(_ , TLet {T₁ = T₁} {Γ₂ = Γ₂} _ t₁-typable _ _) → contradiction ((T₁ , Γ₂) , t₁-typable) t₁-untypable }
... | yes ((T₁ , Γ₂) , T₁-proof) with typeOf (Γ₂ , x ↦ T₁) t₂
... | no t₂-untypable = no λ {(_ , TLet {T₂ = T₂} {Γ₃ = Γ₃} _ t₁-typable t₂-typable _) → case typing-unique T₁-proof t₁-typable of λ { (refl , refl) → contradiction ((T₂ , Γ₃) , t₂-typable) t₂-untypable } }
... | yes ((T₂ , Γ₃) , T₂-proof) with divideContext Γ₃ (∅ , x ↦ T₁)
... | no Γ₃-nodiv = no  λ {(_ , TLet  {Γ₄ = Γ₄} _ t₁-typable t₂-typable Γ₃-div) → case typing-unique T₁-proof t₁-typable of λ { (refl , refl) → case typing-unique T₂-proof t₂-typable of λ { (refl , refl) →  contradiction (Γ₄ , Γ₃-div) Γ₃-nodiv} } }
... | yes (Γ₄ , Γ₄-proof) = yes ((T₂ , Γ₄) , (TLet x-uniq T₁-proof T₂-proof Γ₄-proof))
